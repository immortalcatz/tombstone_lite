...
public class BlockGraveSimple extends BlockDecorativeGraveSimple<TileEntityTombstone> implements IPlayerGrave {
	protected final static String name = "grave_simple";
	public BlockGraveSimple() {
		super(name);
		setCreativeTab(null);
		setBlockUnbreakable();
